...
// Create New Service for our robot
...
class ROBOTHardwareInterface : public hardware_interface::RobotHW 
{
	public:
        ...
        std_msgs::Float64MultiArray joints_pub;

        std_msgs::Float64MultiArray joint_velocity_read;
        std_msgs::Int64MultiArray joint_states_read;
